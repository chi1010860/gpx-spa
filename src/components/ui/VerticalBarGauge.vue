...
export default {
    ...
    methods: {
        init() {
            ...
            // Initial variables
            this.max_level = this.H - this.text_space - this.top_margin
            ...
            ctx.moveTo(this.W / 2, this.start_level)
            ctx.lineTo(this.W / 2, 0 + 10)
            ctx.stroke()
            ...
            ctx.lineWidth = this.line_width
            ctx.moveTo(this.W / 2, this.start_level)
            ctx.lineTo(this.W / 2, this.start_level - this.level)
            ctx.stroke()
            ...
            ctx.fillText(this.text, this.W / 2 - text_width / 2, this.H)
        },
        draw() {
