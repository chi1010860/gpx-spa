...
// Web API for winpc32
// POST /winpc32
router.post('/winpc32', function (req, res) {
    winpc32.MyInitial();
    var uValue;
...
// POST /winpc32/add
router.post('/winpc32/add', function (req, res) {
    let watchBit = 2091;
    let getbitInput = {
        address: watchBit
    }
...
// POST /winpc32/reduce
router.post('/winpc32/reduce', function (req, res) {
    let watchBit = 2091;
    let getbitInput = {
        address: watchBit
    }
...
router.get('/winpc32/light-switch/:id', function (req, res) {
    let nAddress;
